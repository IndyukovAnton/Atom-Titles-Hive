...
Web Titles Tracker — это минималистичное и функциональное приложение для ведения личной медиатеки. Позволяет систематизировать, группировать и анализировать ваши просмотры с подробной статистикой.
...
**Anton Indyukov**  
Portfolio Project — Web Titles Tracker
