...
export function AccountSettings() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <Card className="gap-3 overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-background/60 backdrop-blur-sm md:col-span-2">
          ...
          <div className="flex flex-col sm:flex-row gap-8 items-center sm:items-start animate-in fade-in duration-500">
            ...
            >
              <Avatar className="h-32 w-32 border-4 border-background shadow-2xl transition-transform group-hover:scale-105 group-hover:ring-4 ring-primary/20">
                <AvatarImage
                  src={user?.preferences?.avatar || undefined}
            ...
            <div className="space-y-5 flex-1 w-full max-w-md">
              ...
              <div className="grid gap-2">
                <Label htmlFor="birth-date" className="text-muted-foreground">
                  Дата рождения
                </Label>
                <div className="relative">
      ...
      <div className="flex flex-col gap-6">
        <Card className="gap-3 overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-background/60 backdrop-blur-sm h-fit">
          <CardContent className="p-4">
            ...
            <p className="text-xs text-muted-foreground mt-4 text-center px-4">
              Выход из аккаунта на этом устройстве. Ваши данные останутся
              сохранены.
            </p>
          </CardContent>
        </Card>
